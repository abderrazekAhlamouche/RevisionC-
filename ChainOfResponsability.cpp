...
void ChainOfResponsability::examples(){

	//uncomment and copy the following code to test it 
...
void ChainOfResponsability::execute() {
	std::map<int, int> limits = { {6, 100},{101, 117} };
	Context::execute(limits, "ChainOfResponsability.cpp");
}